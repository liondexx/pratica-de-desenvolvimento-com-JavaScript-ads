...
Descritivo: 37. Verifique se um array contém o elemento "Maçã" usando `.includes()`
****************************************************************************/

const frutas = ["Banana", "Laranja", "Maçã", "Uva"];
const contemMaca = frutas.includes("Maçã");

console.log(contemMaca); 
// Resultado: true